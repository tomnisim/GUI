import { StoreReviewInformation } from "./StoreReviewInformation";
export class StoreInformation  {
    ...
    constructor(data) {
        ...
        this.storeReviewInformation = new StoreReviewInformation(data.StoreReviewInformation)// another class
